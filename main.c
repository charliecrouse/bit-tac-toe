...
unsigned get_active_bit(unsigned x) {
  // TODO
  return 0;
}

unsigned get_symbol_bit(unsigned x) {
  // TODO
  return 0;
}

unsigned get_north_bits(unsigned x) {
  // TODO
  return 0;
}

unsigned get_northwest_bits(unsigned x) {
  // TODO
  return 0;
}

unsigned get_west_bits(unsigned x) {
  // TODO
  return 0;
}
